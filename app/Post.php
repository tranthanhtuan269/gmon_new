...
class Post extends Model
{
    ...
    */
     ...
     * @var array
     */
    protected $fillable = ['title', 'sub_description', 'description', 'category', 'views', 'likes', 'image', 'youtube_link', 'sub_url', 'slug', 'keyword'];
        ...
        if(isset($category) && $category > 0){
            if($post > 0){
                $posts = \DB::table('posts')
                    ...
                    ->select('posts.id', 'posts.title', 'posts.slug', 'posts.keyword', 'posts.description', 'posts.sub_description', 'posts.category', 'posts.image', 'posts.youtube_link', 'posts.created_at')
                    ->where('posts.id', '=', $post)
