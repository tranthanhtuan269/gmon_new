...
<div class="container product-list">
  ...
  <div class="row product-item">
    <div class="col-12 holder-detail"><div class="show-time">{{ date_format(new DateTime($cv->created_at), 'd/m/Y') }}</div><a href="{{ url('/') }}/curriculumvitae/view/{{ $cv->id }}" class="btn btn-sm btn-primary show-detail">Chi tiết</a></div>
    <div class="col-4 col-md-2"><img src="http://test.gmon.com.vn/?image={{ $cv->avatarCV == null ? $cv->avatarU : $cv->avatarCV }}" alt="Smiley face" height="100%" width="100%"></div>
