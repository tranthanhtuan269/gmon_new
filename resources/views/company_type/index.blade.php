                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Name</th><th>Key Word</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="pagination-wrapper"> {!! $company_type->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
