       ...
       <div class="row">
           ...
           <div class="col-lg-9 right">
                <div class="title">
                    ...
                    <span>Nhà tuyển dụng<span class="number">(10)</span></span>
                </div>
                <div class="content">
                    <div class="item row">
                        ...
                        <div class="text col-lg-10">
                            <h3><a href="#">Khách sạn mường thanh <span>(10 công việc mới)</span></a></h3>
                            <p>
                                Mường Thanh là chuỗi khách sạn lớn nhất tại Việt Nam. Tập đoàn cung cấp các dịch vụ nghỉ dưỡng cao cấp
                             tại 50 khách sạn trải dài trên mọi miền đất nước
                            </p>
                            <div class="info">
                                <span>
                                    Công việc <i class="fa fa-briefcase" aria-hidden="true"></i> 35
                                </span>
                                <span>
                                    Theo dõi <i class="fa fa-eye" aria-hidden="true"></i> 2500
                                </span>
                            </div>
                        </div>
                    </div>
