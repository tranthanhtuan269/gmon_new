                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                <div class="row">
                                                    <label class="col-form-label col-md-12">Họ tên đệm(<span class="star">*</span>)</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-3">
                                                <div class="row">
                                                    <label class="col-form-label col-md-12">Tên(<span class="star">*</span>)</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                <div class="row margin-0">
                                                    ...
                                                    <select id="date" class="form-control col-md-12">
