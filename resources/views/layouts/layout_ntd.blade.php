...
<body class="backend">
    ...
    <div class="header-homepage">
        ...
        <style type="text/css">
            ...
            .backend .header-homepage .top-menu .right-menu ul li .dropdown-menu {
                right: 63px;
                color: #fff;
                background: #3c8ec6;
                border: none;
                        ...
                        <ul class="homepage-menu">
                            ...
                            <li>
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item" href="{{ url('/') }}/company/{{ $user_info['company_id'] }}/info">Xem trang tuyển dụng</a>
                                    <a class="dropdown-item" href="{{ url('/') }}/company/editCompany">Cập nhật trang tuyển dụng</a>
                                    <a class="dropdown-item" href="{{ url('/') }}/job/create">Tạo tuyển dụng</a>
                                    @else
       ...
       <div class="container">
           <div class="row">
               <div class="left col-lg-3">
                    <div class="avatar">
                        <img src="http://test.gmon.com.vn/?image={{ $myInfo->logo }}" alt="Avatar">
                    </div>
                    <div class="name">
                        <h3><?php if(isset($myInfo->name)) echo $myInfo->name; else echo \Auth::user()->name; ?></h3>
                        <h4>{{ $myInfo->school }}</h4>
                    </div>
                    <div class="job">
