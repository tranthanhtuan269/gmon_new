            ...
            <div class="row gmon-details">
                <div class="col-sm-12 block block-gallery">
                    <div class="block-content">
                        ...
                        <button type="button" class="btn btn-primary pull-right follow" id="follow-btn" @if($followed) style="display: none;" @else style="display: block; margin-top: 10px;" @endif><i></i>Theo dõi</button>
                        <button type="button" class="btn btn-default pull-right follow" id="unfollow-btn" @if($followed) style="display: block;" @else style="display: none; margin-top: 10px;" @endif><i></i>Bỏ theo dõi</button>
                        @else
